...
```
See the [CakePHP Cronjob docs](https://book.cakephp.org/5/en/console-commands/cron-jobs.html#running-shells-as-cron-jobs) for details.
...
```
Read more about this in the [CakePHP docs](https://book.cakephp.org/5/en/core-libraries/events.html).
